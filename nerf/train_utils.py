...
def predict_and_render_radiance(
    ...
    # Reflect onto positive x-sphere
    with torch.no_grad():
        x_directions = ray_batch[..., 3:6]
        pos_neg = x_directions / torch.abs(x_directions)
        ray_batch[..., 3:6] = pos_neg.expand(ray_batch[..., 3:6].shape)*ray_batch[..., 3:6]
